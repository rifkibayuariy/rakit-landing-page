...
const projects = [
    {
        ...
        image: "portfolio/rakit-smartAttendance.jpeg",
        challenge:
    ...
    },
    {
        ...
        image: "portfolio/rakit-monitoring.jpeg",
        challenge:
...

    {
        ...
        image: "portfolio/rakit-smartFarming.jpeg",
        challenge:
        ...
        >
            ...
            <div className="space-y-0">
                {projects.map((project) => (
                    <section
                        key={project.id}
                        className="project-block min-h-screen border-t border-neutral-900"
                    >
                        <div className="max-w-7xl mx-auto px-8 md:px-16 lg:px-24 py-32 grid lg:grid-cols-12 gap-24">
                            {/* LEFT */}
                                ...
                                <div className="lg:sticky lg:top-24">
                                    <div className="relative border border-neutral-900 overflow-hidden">
                                        <img
                                            src={project.image}
                                            alt={project.title}
                                            className="showcase-image w-full h-105 md:h-120 object-cover scale-105"
                                        />
                                        ...
                                        <div className="absolute inset-0 p-10 flex flex-col justify-between">
                                            ...
                                            <div>
                                                <h3 className="showcase-title text-4xl md:text-5xl lg:text-6xl leading-[0.9] tracking-tight font-medium">
                                                    {project.title}
                                                </h3>
                                        ...
                                        <div className="border-t border-neutral-900 pt-10">
                                            ...
                                            <div className="flex flex-wrap gap-3">
                                                {project.tags.map((tag) => (
                                                    <div
                                                        key={tag}
                                                        className="px-3 py-2 border border-[#D67341] text-xs uppercase tracking-wider text-neutral-400"
                                                    >
                                                        {tag}
                                                    </div>
                                                ))}
