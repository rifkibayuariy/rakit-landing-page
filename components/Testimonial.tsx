                    ...
                    >
                        {[...testimonialsData, ...testimonialsData].map(
                            (item, index) => (
                                ...
                                >
                                    <div className="bg-neutral-50 px-16 py-12">
                                        <div className="flex flex-col">
                                            ...
                                            {/* Teks Kutipan */}
                                            <h3 className="text-xl sm:text-xl md:text-2xl font-semibold tracking-tight text-neutral-700 leading-relaxed md:leading-[1.4] mb-16">
