...
const servicesData = [
    {
        ...
        image: "services/rakit-customMicrocontroller.jpeg",
    },
    {
        id: "02",
        ...
        url: "https://wa.me/6281937894157", // Mengarah ke WhatsApp Business
        image: "services/rakit-3dprint.jpeg",
    },
    {
        id: "03",
        ...
        url: "https://lynk.id/rakitproject", // Mengarah ke Lynk.id
        image: "services/rakit-eBook.jpeg",
    },
];
            ...
            <div className="w-full md:w-5/12 lg:w-1/2 relative md:border-r border-neutral-900">
                <div className="md:sticky md:top-0 md:h-screen flex flex-col justify-center px-8 md:px-16 lg:px-24 py-20 md:py-0 z-20">
                    ...
                    <p className="mt-8 text-lg text-neutral-400 font-light max-w-sm leading-relaxed border-l border-neutral-800 pl-6">
                        Tiga pilar layanan kami dirancang untuk memastikan ide
                        Anda tidak berhenti hanya sebagai konsep digital.
                    </p>
                </div>
            </div>
